        ...
        <div className="z-50 w-[582px]">
          <div className="grid w-full justify-center items-center pt-20 px-10 bg-white rounded-lg ">
            ...
            <p className="w-full px-8 mb-16">
              We need you to verify you email address. We’ve sent an email to{" "}
              <b>emmajones@gmail.com</b> containing 6-digit code. Please enter
              it below.
            </p>
            <form className="w-full">
              ...
              <p className="w-full text-center font-semibold">Didn't receive the code? <span className="text-[#013D84] font-semibold">Resend</span></p>
              <button className="w-full rounded-lg text-center py-4 font-semibold text-white bg-[#013D84]">
                Continue
              </button>
              <div className="mt-12 flex justify-center mb-16">
                ...
                <span className="text-[#557DAD] font-semibold">
                  Return to login
                </span>
              </div>
            </form>

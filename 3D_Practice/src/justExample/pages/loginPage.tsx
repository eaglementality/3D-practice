  ...
  return (
    <div className=" z-50  flex  w-full justify-center ">
      ...
      <div className="bg-[#013D84] w-full py-16 px-10 rounded-lg">
        <h4 className="font-semibold mb-5 w-full text-white text-center text-3xl">
          Forgot Password?
        </h4>
        <p className="w-full text-white text-md px-8 mb-20">
          Click the "forget password button" below to enter your email address
          to recieve a password reset link
        </p>
        <button className="w-full text-center py-4 px-40 text-[#013D84] mb-5 bg-white rounded-lg">
          Forgot password
        </button>
